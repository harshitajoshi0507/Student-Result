...
{   ?>
                                                    ...
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- 2025,2026,2027,2028</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                        <label for="success" class="control-label">Batch Year</label>
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- 1,2,4,3 etc</span>
                                                        </div>
                                                    </div>
                                                     <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                            ...
                                                            <span class="help-block">Eg- CSE,EEE,ECE,Mech, Civil etc</span>
                                                        </div>
                                                    </div>
                                                    <?php }} ?>
  <div class="form-group has-success">
